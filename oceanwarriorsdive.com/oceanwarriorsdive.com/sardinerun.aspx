...
<asp:Content ID="Head" ContentPlaceHolderID="Head" runat="Server">
    <title>About - Ocean Warriors Dive</title>
</asp:Content>
            ...
            <div class="container py-lg-5 py-md-4 py-2">
                <div class="row">
                    <div class="col-lg-6 align-self pr-lg-5">
                        ...
                        <h3 class="w3l-hnytitle">Sardine Run 2025 – The Greatest Ocean Spectacle on Earth</h3>
                        <p class="mt-4">
                            ...
                            <b>Price: R2,500 p.p. – Exclusive group offer: Book 8, Pay for 7!</b>
                        </p>
        ...
        <div class="container py-md-5 py-3">
            <div class="row stats-icon text-center">
                <div class="col-lg-4 col-md-6 stats_info">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, Ea conseq untur illum facere aperiam sequi optio.
    ...
    <section class="w3l-content-4 py-5" id="features">
        <div class="content-4-main py-lg-5 py-md-4 py-2">
            <div class="container">
                ...
                <h3 class="w3l-hnytitle mb-5 text-center">Our Lessons</h3>
                <div class="content-info-in row">
